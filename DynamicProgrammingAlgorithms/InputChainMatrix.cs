...
{
    public partial class InputChainMatrix : Form
    {
        private int matrixCount = 0;
        private string dimension = "";
        public InputChainMatrix()
        {
            InitializeComponent();
        }
        ...
        {
            if (textBox2.Text.Split(' ').Length == matrixCount+1)
            {
